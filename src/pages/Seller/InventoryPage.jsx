...
import { DisplayTags, ItemWide, Item_card_B, SearchBar } from '../../components/SearchDisplay'
...
const InventoryPage = ({ navigation }) => {
  ...
  return (
    <View style={styles.g_container} >
      ...
      <TouchableOpacity style={styles.plus_btn} onPress={() => { navigation.navigate('AddItem_Category') }} >
        <Plus />
      </TouchableOpacity>
